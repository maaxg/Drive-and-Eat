...
const ScreenFive = ({navigation}) => {
  const {name, phone, birth, email, password, setLogged} = useContext(
    UserContext,
  );
    ...
    <ScrollView style={{flex: 1, backgroundColor: '#EF6E6E'}}>
      <View style={styles.scrollContainer}>
        ...
        <Text
          style={[
            styles.text,
            {fontSize: 20, marginBottom: '5%', fontWeight: '700'},
          ]}>
          Digite o código que lhe foi enviado!
        </Text>
        <TextInput
          placeholder={'Código'}
          style={styles.input}
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              styles.text,
              {marginLeft: 0, color: '#EF6E6E', textAlign: 'center'},
            ]}>
            CONTINUAR
          </Text>
        </TouchableOpacity>
